...
public class ApuestaTest{
    ...
    public void testBet(){
        ...
        assertEquals("Betting with a unique number and 2to1 and red not good", Double.valueOf(400.0), apuesta.ganancia("1"));

        // Betting with a unique number and 2to1 and red and black (black loosing)
        apuesta.apostar("black", 10.0);
        assertEquals("Betting with a unique number and 2to1 and red and black (black loosing) not good", Double.valueOf(400.0), apuesta.ganancia("1"));

        // Betting on two numbers
        apuesta.apostar("2", 10.0);
        assertEquals("Betting with two numbers not good", Double.valueOf(360.0+20+20), apuesta.ganancia("1"));
        ...
        assertEquals("Betting on 1to18 not good", Double.valueOf(360.0+20+20+20), apuesta.ganancia("1"));
